...
class LastDayController {
    ...
    def index = { 
        ...
        DynamicReport dr = drb.setTitle("Total rezervari pentru ziua precedenta \\n" + formatter.format(new Date(System.currentTimeMillis() - 1000 * 60 *60 *24))).setUseFullPageWidth(true).build();
        JRDataSource ds = new JRBeanCollectionDataSource(LastDayCharges.list());   
