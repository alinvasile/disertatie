...
<body>
	...
	<div class="nav">
		...
		<span class="menuButton"><g:link class="list" action="list">Roles List</g:link></span>
		<span class="menuButton"><g:link class="create" action="create">New Roles</g:link></span>
	</div>
	...
	<div class="body">
		...
		<g:form>
			...
			<tbody>
				<tr class="prop">
					<td valign="top" class="name"><label for="authority">Roles Name:</label></td>
